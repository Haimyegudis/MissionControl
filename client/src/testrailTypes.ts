// TestRail client-side types (Phase 3 — unified-deck plan T12).
// Mirror of server/src/testrail/types.ts (camelCase wire shapes) plus the
// service response envelopes (session status, meta, prefetch progress).
...
// ---------------------------------------------------------------------------
// Service envelopes (server/src/testrail/service.ts)
// ---------------------------------------------------------------------------
