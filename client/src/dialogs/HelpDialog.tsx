  ...
  return (
    <>
      <Section title="Pages">
        ...
        <Item name="Time Spent">one scope bar (Day/Week/Month/Sprint/Custom) picks the window; switch its presentation between Timesheet, Summary, Epics, Calendar (month) and Board (sprint) views; CSV + PDF export.</Item>
